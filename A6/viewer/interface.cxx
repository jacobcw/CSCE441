...
Fl_Button *view_button=(Fl_Button *)0;
...
#endif
	  { Fl_Button* o = view_button = new Fl_Button(535, 495, 75, 40, "View");
        o->callback((Fl_Callback*)view_callback, (void*)(0));
      }
	  { Fl_Button* o = save_button = new Fl_Button(425, 495, 75, 40, "Save");
        o->callback((Fl_Callback*)save_callback, (void*)(0));
      }
